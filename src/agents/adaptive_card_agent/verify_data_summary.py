...
async def run_prompt(prompt: str, i: int):
    ...
    user_id = f"summary_test_user_{i}"
    session_id = f"summary_test_session_{i}"
...
async def main():
    print("Running Data Summary Fix Verification...")
    
    prompts = [
        "Display the weekly user growth stats.",
        "Show me the sales report for Q2.",
